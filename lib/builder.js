...
class Builder {
    ...
    nextCursor (raw, transport) {
        transport.transport.header.query[xmlAttrKey].cursor = raw.transport.header.query[xmlAttrKey].cursor
        return raw.transport.header.query[xmlAttrKey].cursor
    }
